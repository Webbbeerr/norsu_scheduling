...
final class Version20251222120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE schedules SET day_pattern = 'M-T-W-TH-F' WHERE day_pattern = 'MTWTHF'");
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE schedules SET day_pattern = 'MTWTHF' WHERE day_pattern = 'M-T-W-TH-F'");
